...
public class VideoDownloading extends BaseActivity implements DownloadFileListAdapter.OnItemSelectListener{
    ...
    private TextView pause,delete,start;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDownloadFileListAdapter = new DownloadFileListAdapter(this, 1);
    ...
    public void initView(){
        ...
        pause=(TextView)findViewById(R.id.downloading_pause);
        delete=(TextView)findViewById(R.id.downloading_delete);
        start=(TextView)findViewById(R.id.downloading_start);
        pause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(mDownloadFileListAdapter.getCount()>0) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mDownloadFileListAdapter.getCount()>0) {
                    deleteAllFiles(true, mDownloadFileListAdapter.getFilesInfo());
                }
            }
        });
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mDownloadFileListAdapter.getCount()>0) {
                   startAllFiles(mDownloadFileListAdapter.getFilesInfo());
                }
            }
        });
    }
    ...
    public void onSelected(final List<DownloadFileInfo> selectDownloadFileInfos) {
        ...
        mBtnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(VideoDownloading.this);
        ...
        mBtnMove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etFileDir = new EditText(VideoDownloading.this);
                etFileDir.setText(oldDirPath);
                etFileDir.setFocusable(true);

                LinearLayout linearLayout = new LinearLayout(VideoDownloading.this);
        ...
        mBtnRename.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (urls.size() == 1) {
                    ...
                    final EditText etFileName = new EditText(VideoDownloading.this);
                    etFileName.setText(oldName);
                    etFileName.setFocusable(true);

                    final CheckBox cbIncludedSuffix = new CheckBox(VideoDownloading.this);
    ...
    private void deleteAllFiles(boolean deleteDownloadedFile, List<DownloadFileInfo> selectDownloadFileInfos) {
    ...
    private void startAllFiles(List<DownloadFileInfo> selectDownloadFileInfos){
        for(int i=0;i<selectDownloadFileInfos.size();i++){
            if(selectDownloadFileInfos.get(i).getStatus()==Status.DOWNLOAD_STATUS_PAUSED){
                FileDownloader.start(selectDownloadFileInfos.get(i).getUrl());
            }
        }
    }
