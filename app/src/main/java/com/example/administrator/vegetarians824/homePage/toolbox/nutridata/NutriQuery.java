...
import com.example.administrator.vegetarians824.dongdong.JKsheruResult;
...
public class NutriQuery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutri_query);
    ...
    public void initopera(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(NutriQuery.this,JKsheruResult.class);
    ...
    public void getMydata(){
        ...
        SlingleVolleyRequestQueue.getInstance(NutriQuery.this).addToRequestQueue(request);
    }
